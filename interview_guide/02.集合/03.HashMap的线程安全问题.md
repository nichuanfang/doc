...
![](./img/map线程安全性问题-第10页.png)

正常的ReHash，得到的结果如下图所示：

![](./img/map线程安全性问题-第9页.png)
...
![](./img/map线程安全性问题-第7页.png)

紧接着线程2 执行`tab[i] = newNode(hash, key, value, null);`

此时table会变成如下状态:

![](./img/map线程安全性问题-第8页.png)
