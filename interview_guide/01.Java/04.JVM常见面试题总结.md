...
![Java 运行时数据区域（JDK1.7）](./img/java-runtime-data-areas-jdk1.7.png)

**JDK 1.8**：

![Java 运行时数据区域（JDK1.8 ）](./img/java-runtime-data-areas-jdk1.8.png)
...
![堆内存结构](./img/hotspot-heap-structure.png)
...
![method-area-jdk1.6](./img/method-area-jdk1.6.png)

![method-area-jdk1.7](./img/method-area-jdk1.7.png)
...
![对象的访问定位-使用句柄](./img/access-location-of-object-handle.png)

#### 直接指针

如果使用直接指针访问，reference 中存储的直接就是对象的地址。

![对象的访问定位-直接指针](./img/access-location-of-object-handle-direct-pointer.png)
...
![对象之间循环引用](./img/object-circular-reference.png)
...
![Java 引用类型总结](./img/java-reference-type.png)
...
![标记-清除算法](./img/mark-and-sweep-garbage-collection-algorithm.png)
...
![复制算法](./img/copying-garbage-collection-algorithm.png)
...
![标记-整理算法](./img/mark-and-compact-garbage-collection-algorithm.png)
...
![G1 收集器](./img/g1-garbage-collector.png)
...
![类加载器层次关系图](./img/class-loader-parents-delegation-model.png)
...
![Tomcat 的类加载器的层次结构](./img/tomcat-class-loader-parents-delegation-model.png)
...
![](./img/idea-vm-options-heapdump.png)
...
![Mat Leak Suspects Report](./img/mat-leak-suspects-report.png)

下图中的 Problem Suspect 1 就是可能出现内存泄露的问题分析：

![](./img/mat-problem-suspect-1.png)
...
![](./img/mat-problem-suspect-1-details.png)
