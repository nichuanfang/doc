...
![](./img/image-20210226195426092.png)
...
4. 调用 invoke()方法。调用 invoke 方法的流程如下：
   ...
   ![](./img/image-20210226195531619.png)
...
![](./img/image-20210226222339606.png)
...
![](./img/image-20210227103256234.png)
...
![](./img/image-20210227113301593.png)
...
- **对象适配器**：Adapter 类（适配器）持有 Adaptee 类（源角色）对象实例，实现 Target 接口（目标角色）
  ![](./img/image-20210227114919307.png)
...
![](./img/image-20210227115040999.png)
